...
2\. \*\*Containerização (Docker):\*\* Acesso à instância via SSH, instalação do serviço Docker e execução da imagem pública solicitada (`kennethreitz/httpbin`)\[cite: 2].
...
Abaixo estão as capturas de tela ou saídas dos comandos executados\[cite: 2] validando os endpoints da aplicação através do IP público da AWS.
...
\*Desafio realizado por Flávio Zini.\*
